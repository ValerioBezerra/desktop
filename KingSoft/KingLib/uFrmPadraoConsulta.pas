...
uses
  ...
  Vcl.ExtCtrls, Vcl.Grids, Vcl.DBGrids, unKsDBGrid, Data.DB, Datasnap.DBClient;
...
procedure TfrmPadraoConsulta.btnEditarClick(Sender: TObject);
begin
  //
end;
...
procedure TfrmPadraoConsulta.btnNovoClick(Sender: TObject);
begin
  //
end;
...
procedure TfrmPadraoConsulta.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  ...
  if (Ord(Key) = VK_F6) and (MostrarConfirmar) then
