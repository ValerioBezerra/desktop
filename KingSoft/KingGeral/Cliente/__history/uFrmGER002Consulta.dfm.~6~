inherited frmGER002Consulta: TfrmGER002Consulta
  Caption = 'frmGER002Consulta'
  ClientWidth = 743
  ...
  inherited cdsConsulta: TClientDataSet
    CommandText = 
      'SELECT * FROM GER_EST LEFT OUTER JOIN GER_PAI ON GER_ID_PAI = GE' +
      'R_GERPAI_EST WHERE 1 = 0'
