...
type
  TfrmGER009Consulta = class(TfrmPadraoConsulta)
...
var
  frmGER009Consulta: TfrmGER009Consulta;
...
procedure TfrmGER009Consulta.btnApagarClick(Sender: TObject);
begin
  OperacaoPadrao := 'D';
...
procedure TfrmGER009Consulta.btnEditarClick(Sender: TObject);
begin
  inherited;
  try
    PreencherCdsPadrao(cdsConsulta.FieldByName('GER_ID_TPP').AsInteger);
...
procedure TfrmGER009Consulta.btnNovoClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TfrmGER009Consulta.FormCreate(Sender: TObject);
begin
  inherited;
  Campos        := '*';
  Tabela        := 'GER_TPP';
...
procedure TfrmGER009Consulta.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmGER009Consulta.PreencherCdsPadrao(Id: Integer);
begin
  cdsPadrao.Close;
