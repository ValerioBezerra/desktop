inherited frmGER004Consulta: TfrmGER004Consulta
  Caption = 'frmGER004Consulta'
  ClientWidth = 743
  ...
  inherited cdsConsulta: TClientDataSet
    CommandText = 
      'SELECT * FROM GER_BAI LEFT OUTER JOIN GER_CID ON GER_ID_CID = GE' +
      'R_GERCID_BAI LEFT OUTER JOIN GER_EST ON GER_ID_EST = GER_GEREST_' +
      'CID WHERE 1 = 0'
