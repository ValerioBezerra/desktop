...
begin
       ...
       cdsPEDIDOVlrTotal.Value := cdsPEDIDOVlrUnitario.Value * cdsPEDIDOQuantidade.Value;
        cdsPEDIDOcodigo.Value := dm.DataModule2.cdsCONSULTA.FieldByName('COD_PRODUTO').AsString;
       AtualizarTotal;
...
begin
     ...
     //gravando os itens do pedido
        ...
        begin
          ...
          dm.DataModule2.cdsPROXPED.FieldByName('CODPRODUTO_PROXPED').AsString := VartoStr(cdsPEDIDOcodigo.Value);
