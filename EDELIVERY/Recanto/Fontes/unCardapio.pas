...
begin
   ...
   DataModule1.cdsGRAVAR.CommandText := 'delete from produto_dia where codpro_prodia = ' +
                                         Datamodule1.cdsPRODIAA.FieldByName('codpro_prodia').AsString +
                                         ' and data_prodia = ' +  quotedstr(FormatDateTime('mm/dd/yyyy',DateTimePicker1.Date));
  // DataModule1.cdsGRAVAR.Open;
   DataModule1.cdsGRAVAR.Execute;
...
begin
   DataModule1.cdsGRAVAR.Close;
   DataModule1.cdsGRAVAR.CommandText := 'delete from produto_dia where codpro_prodia = ' +
                                         Datamodule1.cdsPRODIAP.FieldByName('codpro_prodia').AsString +
                                         ' and data_prodia = ' +  quotedstr(FormatDateTime('mm/dd/yyyy',DateTimePicker1.Date));
  // DataModule1.cdsGRAVAR.Open;
   DataModule1.cdsGRAVAR.Execute;
