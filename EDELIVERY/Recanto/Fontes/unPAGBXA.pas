...
procedure TfrmPAGBXA.btnApagarClick(Sender: TObject);
var
...
procedure TfrmPAGBXA.btnEditarClick(Sender: TObject);
begin
...
procedure TfrmPAGBXA.btnNovoClick(Sender: TObject);
begin
  inherited;
  Application.CreateForm(TFrmMOVPAGTIT,frmMOVPAGTIT);
   cdsPadrao.Open;
...
procedure TfrmPAGBXA.btnPesquisarClick(Sender: TObject);
begin
     where := '';
...
procedure TfrmPAGBXA.executarSQL;
begin
...
procedure TfrmPAGBXA.FormCreate(Sender: TObject);
begin
  inherited;
