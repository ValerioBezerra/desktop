...
procedure TfrmFinanceiro.ppFooterBand1BeforePrint(Sender: TObject);
begin
   lblTotal.Text := TotalStr;
   case RadioGroup1.ItemIndex of
     0: lblSituação.Text := 'Pagos';
     1: lblSituação.Text := 'Em aberto';
     2: lblSituação.Text := 'Todos';
   end;
