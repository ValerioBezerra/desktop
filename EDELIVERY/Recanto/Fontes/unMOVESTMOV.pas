...
procedure TfrmMOVESTMOV.DBEdit3Exit(Sender: TObject);
begin
  inherited;
     with DataModule1.cdsTELASCONSULTA do
     begin
       close;
       CommandText := 'select * from estite where CODIGO_ITE = ' + dbedit4.Text;
       Open;
       if not IsEmpty then
          ednomefornecedor.Text := FieldByName('DESCRICAO_ITE').AsString
       else
           ednomefornecedor.Text  := 'Item não cadastrado';
     end;
end;
...
begin
   with DataModule1.cdsTELASCONSULTA do
     begin
       close;
       CommandText := 'select * from esttmo where CODIGO_TMO = ' + dbedit4.Text;
       Open;
       if not IsEmpty then
          ednomefornecedor.Text := FieldByName('DESCRICAO_TMO').AsString
       else
           ednomefornecedor.Text  := 'Tipo de movimento não cadastrado';
     end;
...
begin
  ...
  cdsPadrao := DataModule1.cdsESTMOV;
end;
